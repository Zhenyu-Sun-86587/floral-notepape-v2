...
- P7-B 胶囊收纳尚未开始，当前没有将普通隐藏标作“已收纳”。Windows 静默启动、多屏缩放、快捷键冲突与托盘找回仍待用户 GUI 验收。

## 范围

Windows 已完成 P3 文件绑定闭环、P4 代码交付、P5 外观与材质、P6 的静默恢复、逐便签布局和全局快捷键；P7-A 桌面附着已交付待 GUI 验收，P7-B 胶囊收纳尚未开始。macOS 交接见 `MAC_HANDOFF.md`。
